  ...
  return (
    <div className="flex justify-center items-start min-h-screen pt-32">
      <div className=" align-middle max-w-3xl p-6 rounded-lg shadow-md">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Präambel</h2>
        ...
        <ul className="index">
          <li className="text-base text-gray-700">
            <a className="text-blue-600 hover:underline">Präambel</a>
          </li>
          <li className="text-base text-gray-700">
            <a className="text-blue-600 hover:underline">Verantwortlicher</a>
          </li>
          <li className="text-base text-gray-700">
          ...
          <li className="text-base text-gray-700">
            <a className="text-blue-600 hover:underline">Einsatz von Cookies</a>
          </li>
          <li className="text-base text-gray-700">
            <a className="text-blue-600 hover:underline">
        ...
        <p className="text-base text-gray-700 leading-relaxed mb-4">
          Vertretungsberechtigte Personen: Sabine Ehmann
        </p>
        <p className="text-base text-gray-700 leading-relaxed mb-4">
          E-Mail-Adresse: sabine.ehmann@eh-co.com
        </p>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          <li className="text-base text-gray-700">Bestandsdaten.</li>
          <li className="text-base text-gray-700">Standortdaten.</li>
          <li className="text-base text-gray-700">Kontaktdaten.</li>
          <li className="text-base text-gray-700">Inhaltsdaten.</li>
          <li className="text-base text-gray-700">Nutzungsdaten.</li>
          <li className="text-base text-gray-700">
            Meta-, Kommunikations- und Verfahrensdaten.
          </li>
          <li className="text-base text-gray-700">Protokolldaten.</li>
        </ul>
        <h3 className="text-xl font-medium text-gray-700 mb-3">
          Kategorien betroffener Personen
        </h3>
        <ul className="list-disc list-inside space-y-2 mb-4">
          <li className="text-base text-gray-700">Kommunikationspartner.</li>
          <li className="text-base text-gray-700">Nutzer.</li>
        </ul>
        <h3 className="text-xl font-medium text-gray-700 mb-3">
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <li className="text-base text-gray-700">Kommunikation.</li>
          <li className="text-base text-gray-700">Sicherheitsmaßnahmen.</li>
          <li className="text-base text-gray-700">Reichweitenmessung.</li>
          <li className="text-base text-gray-700">Tracking.</li>
          <li className="text-base text-gray-700">Zielgruppenbildung.</li>
          <li className="text-base text-gray-700">
            Organisations- und Verwaltungsverfahren.
          </li>
          <li className="text-base text-gray-700">Feedback.</li>
          <li className="text-base text-gray-700">Marketing.</li>
          <li className="text-base text-gray-700">
          ...
          <li className="text-base text-gray-700">Öffentlichkeitsarbeit.</li>
        </ul>
        ...
        <p className="text-base text-gray-700 leading-relaxed mb-4">
          ...
          von Diensten Dritter oder der Offenlegung bzw. Übermittlung von Daten
          an andere Personen, Stellen oder Unternehmen geschieht (was erkennbar
          wird anhand der Postadresse des jeweiligen Anbieters oder wenn in der
        ...
        <p className="text-base text-gray-700 leading-relaxed mb-4">
          ...
          stellen wir sicher, dass Ihre Daten auch bei etwaigen politischen oder
        ...
        <p className="text-base text-gray-700 leading-relaxed mb-4">
          ...
          eines Datums, ist stets die längste Frist maßgeblich. Daten, die nicht
          mehr für den ursprünglich vorgesehenen Zweck, sondern aufgrund
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <li className="text-base text-gray-700">
            ...
            (§ 147 Abs. 1 Nr. 4 und 4a i.V.m. Abs. 3 Satz 1 AO sowie § 257 Abs.
            1 Nr. 4 i.V.m. Abs. 4 HGB).
          </li>
          <li className="text-base text-gray-700">
        ...
        <ul className="m-elements">
          <li className="text-base text-gray-700">
            ...
            der Nutzung verschiedener Geräte erstellt, wobei Cookies eingesetzt
            werden können. Google Analytics protokolliert und speichert keine
            individuellen IP-Adressen für EU-Nutzer. Analytics stellt jedoch
            ...
            Sie werden nicht protokolliert, sind nicht zugänglich und werden
        ...
        <ul className="m-elements">
          ...
          <li className="text-base text-gray-700">
            <strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres
            Onlineangebotes und Nutzerfreundlichkeit; Reichweitenmessung
            (z.&nbsp;B. Zugriffsstatistiken, Erkennung wiederkehrender
            Besucher); Tracking (z.&nbsp;B. interessens-/verhaltensbezogenes
